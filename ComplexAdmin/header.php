  ...
  <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="home.php">
	  <img src="https://www.flaticon.com/svg/vstatic/svg/3135/3135768.svg?token=exp=1611309683~hmac=210099a4d0928564cae831fcd7663c3c" class="logo-icon" alt="logo icon">
       <h3 class="logo-text"><b>Stressing.eu</b></h3> 
     </a>
   </div>
   <div class="user-details">
    <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
      <div class="avatar"><img class="mr-3 side-user-img" src="https://www.flaticon.com/svg/vstatic/svg/3135/3135768.svg?token=exp=1611309683~hmac=210099a4d0928564cae831fcd7663c3c" alt="user avatar"></div>
      ...
      <li class="sidebar-header">NAVIGATION</li>
	   <li>
        <a href="home.php" class="waves-effect">
          <i class="fad fa-home" style="color: black;"></i> <span>Home</span>
        </a>
      </li>
 <li>
        <a href="apim.php" class="waves-effect">
          <i class="fad fa-server" style="color: black;"></i> <span>Add Servers</span>
        </a>
      </li>
<li>
        <a href="plansm.php" class="waves-effect">
          <i class="fad fa-shopping-basket" style="color: black;"></i> <span>Add Plans</span>
        </a>
      </li>
<li>
        <a href="usersm.php" class="waves-effect">
          <i class="fad fa-users" style="color: black;"></i> <span>Users List</span>
        </a>
      </li>


<li>
        <a href="live.php" class="waves-effect">
          <i class="fas fa-refresh fa-spin" style="color: black;"></i> <span>Live Attacks</span>
        </a>
      </li>
<li>
        <a href="newsm.php" class="waves-effect">
          <i class="fad fa-tags" style="color: black;"></i> <span>News Settings</span>
        </a>
      </li>

<li>
        <a href="giftcards.php" class="waves-effect">
          <i class="fad fa-qrcode" style="color: black;"></i> <span>Shoppy Code</span>
        </a>
      </li>


<li>
        <a href="control.php" class="waves-effect">
          <i class="fad fa-user" style="color: black;"></i> <span>Online Users</span>
        </a>
      </li>

<li>
        <a href="blacklist.php" class="waves-effect">
          <i class="fad fa-cog" style="color: black;"></i> <span>BlackList</span>
        </a>
      </li>

 <li>
        <a href="balance.php" class="waves-effect">
          <i class="fas fa-money" style="color: black;"></i> <span>Balance Logs</span>
        </a>
      </li>


 <li>
        <a href="alogs.php" class="waves-effect">
          <i class="fad fa-rocket" style="color: black;"></i> <span>Attacks Logs</span>
        </a>
      </li>
 <li>
        <a href="../home.php" class="waves-effect">
          <i class="fas fa-chevron-left" style="color: black;"></i> <span>Go Back</span>
        </a>
      </li>
   ...
   <i class="fad fa-users text-primary"></i><span class="badge badge-primary badge-up"><bb class="" id="getOnlinesUsers"></bb></span> </a>
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="https://www.flaticon.com/svg/vstatic/svg/3135/3135768.svg?token=exp=1611309683~hmac=210099a4d0928564cae831fcd7663c3c" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="https://www.flaticon.com/svg/vstatic/svg/3135/3135768.svg?token=exp=1611309683~hmac=210099a4d0928564cae831fcd7663c3c" alt="user avatar"></div>
            <div class="media-body">
