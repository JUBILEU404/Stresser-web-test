  ...
  <!--Start sidebar-wrapper-->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="home.php">
	  <img src="https://cdn.iconscout.com/icon/free/png-512/flash-dc-superhero-fastest-man-hero-justice-league-earth-saver-28697.png" class="logo-icon" alt="logo icon">
      ...
      <li class="sidebar-header">NAVIGATION</li>
	   <li>
        <a href="home.php" class="waves-effect">
          <i class="fas fa-th-large" style="color: black;"></i> <span>Dashboard</span>
        </a>
      </li>

 <li>
        <a href="hub.php" class="waves-effect">
          <i class="fad fa-rocket" style="color: black;"></i> <span>Stress Panel</span>
        </a>
      </li>
 <li>
        <a href="purchase.php" class="waves-effect">
          <i class="fad fa-shopping-basket" style="color: black;"></i> <span>Purchase Order</span>
        </a>
      </li>
 <li>
        <a href="giftcards.php" class="waves-effect">
          <i class="fad fa-qrcode" style="color: black;"></i> <span>Redeem Code</span>
        </a>
      </li>
 <li>
        <a href="api.php" class="waves-effect">
          <i class="fad fa-link" style="color: black;"></i> <span>Api Dev</span>
        </a>
      </li>

<li>
        <a href="https://t.me/stressingfree" class="waves-effect">
          <i class="fad fa-paper-plane" style="color: black;"></i> <span>Telegram Channel</span>
        </a>
      </li>
...
<?php
        ...
        <a href="ComplexAdmin/home.php" class="waves-effect">
          <i class="fa fa-power"></i> <span>Admin Panel</span>
        </a>
      </li><?php  }?>
   ...
   <i class="fad fa-users text-primary"></i><span class="badge badge-primary badge-up"><bb class="" id="getOnlinesUsers"></bb></span> </a>
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="img/avatar.jpg" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="img/avatar.jpg" alt="user avatar"></div>
