...
<div class="row mt-3">
       <div class="col-12 col-lg-6 col-xl-3">
         <div class="card gradient-deepblue">
           <div class="card-body">
              <h5 class="text-white mb-0"><?php echo $TotalAttacks+67412; ?> <span class="float-right"><i class="fad fa-bolt"></i></span></h5>
       ...
       <div class="col-12 col-lg-6 col-xl-3">
         <div class="card gradient-ohhappiness">
            <div class="card-body">
              <h5 class="text-white mb-0"><?php echo $RunningAttacks+3; ?> <span class="float-right"><i class="fad fa-circle-notch fa-spin"></i></span></h5>
                <div class="progress my-3" style="height:3px;">
                   <div class="progress-bar" style="width:<?php echo $RunningAttacks+3; ?>0%"></div>
                </div>
       ...
       <div class="col-12 col-lg-6 col-xl-3">
         <div class="card gradient-ibiza">
            <div class="card-body">
              <h5 class="text-white mb-0"><?php echo $TotalUsers+3410; ?> <span class="float-right"><i class="fad fa-user-secret"></i></span></h5>
                <div class="progress my-3" style="height:3px;">
                   <div class="progress-bar" style="width:55%"></div>
                </div>
    ...
    <div class="pricing-table">
     ...
     <div class="price-title text-white"><?php echo $_SESSION['username']; ?></div>
       <h2 class="price text-white"><small class="currency"><span class="user-profileee"><img src="img/avatar.jpg" class="img-circle" alt="user avatar"></span></small></h2>
    </div>
    <div class="card-body text-center rounded-bottom">
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item"><b>Expire Plan </b><span class="badge badge-primary shadow-primary m-1"> <?php echo $date ?></span></li>
      </ul>
      <a href="purchase.php" class="btn btn-primary my-3 btn-round">Join Our Vip</a>
    </div>
     </div>
     </div>
    </div>
